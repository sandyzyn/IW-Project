...
data = pd.read_csv('orco gene - CFD - Geneious Comparison .csv')
...
results_df.to_excel('comparisons_B_cfd_G.xlsx', index=False)
...
plt.title('Comparison of Specificity Scores: Benchling (CFD) vs Geneious')
plt.xlabel('Exon')
...
plt.title('Correlation Between Benchling(CFD) and Geneious Scores', fontsize=14)
